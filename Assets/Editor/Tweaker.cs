...
public class Tweaker : EditorWindow
{
    ...
    void InitVariables()
    {
        ...
        player.variables["Acceleration"] = controller.Acceleration;
        player.variables["Decceleration"] = controller.Decceleration;
        ...
        player.variables["BoxLength"] = attack.BoxLength;
